...
@NgModule({
    ...
    declarations: [
        ...
        ScenarioEditorComponent, CreateScenarioWizardComponent, EditScenarioEditorComponent,
        EditScenarioWizardComponent, ScenarioWizardComponent, ScenarioListComponent
    ],
    exports: [
        ScenarioDetailsComponent, CreateScenarioEditorComponent, EditScenarioEditorComponent,
        ScenarioEditorComponent, CreateScenarioWizardComponent, EditScenarioEditorComponent,
