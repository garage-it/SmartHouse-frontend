...
export default [
    ...
    {path: '/scenarios/create-editor', name: 'CreateScenarioEditor', component: CreateScenarioEditorComponent},
    {path: '/scenarios/create-wizard', name: 'CreateScenarioWizard', component: CreateScenarioWizardComponent},
    {path: '/scenario/editor/:id', name: 'EditScenarioEditor', component: EditScenarioEditorComponent},
    {path: '/scenario/wizard/:id', name: 'EditScenarioWizard', component: EditScenarioWizardComponent},
